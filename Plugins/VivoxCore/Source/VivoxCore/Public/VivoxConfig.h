...
enum media_codec_type {
     ...
     * @deprecated
     */
    VX_DEPRECATED_ENUM_GCC(media_codec_type_pcmu, 5.19) = 2 /* PCMU functionality has been removed */
};
VX_DEPRECATED_ENUM_MSC(media_codec_type_pcmu)
...
public:
    ...
    * Codec type none = 0, codec type siren14 = 1, codec type nm = 3,
    * codec type speex = 4, codec type siren7 = 5, codec type opus = 6, codec type pcmu = 6
