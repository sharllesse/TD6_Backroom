...
struct VIVOXMODERATION_API HttpRetryManager
	: public FManager
{
...
struct VIVOXMODERATION_API HttpRetryParams
{
	HttpRetryParams(
...
class VIVOXMODERATION_API Model
{
public:
	virtual ~Model() {}
...
class VIVOXMODERATION_API Request
{
public:
	virtual ~Request() {}
...
class VIVOXMODERATION_API Response
{
public:
	virtual ~Response() {}
	virtual bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) = 0;
